//package net.notcherry.dungeonmod.api.mana;
//
...
//            spellSelection = ClientManaData.getSyncedSpellData(player).getSpellSelection();
//        } else {
//            spellSelection = MagicData.getPlayerMagicData(player).getSyncedData().getSpellSelection();
//        }
//
//        if (Log.SPELL_SELECTION) {
//            DungeonMod.LOGGER.debug("SpellSelectionManager init.begin spellSelection:{} valid:{} index:{} isClient:{}", spellSelection, selectionValid, selectionIndex, player.level.isClientSide);
//        }
//
...
//
//        if (Log.SPELL_SELECTION) {
//            DungeonMod.LOGGER.debug("SpellSelectionManager init.end spellSelection:{} valid:{} index:{} isClient:{}", spellSelection, selectionValid, selectionIndex, player.level.isClientSide);
//        }
//    }
//
