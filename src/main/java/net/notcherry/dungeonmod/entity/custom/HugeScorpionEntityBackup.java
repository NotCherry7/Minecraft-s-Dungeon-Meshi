...
public class HugeScorpionEntityBackup extends Animal {
    private static final EntityDataAccessor<Boolean> ATTACKING =
            SynchedEntityData.defineId(HugeScorpionEntityBackup.class, EntityDataSerializers.BOOLEAN);

    public HugeScorpionEntityBackup(EntityType<? extends Animal> pEntityType, Level pLevel) {
    ...
    protected void registerGoals() {
        ...
        this.goalSelector.addGoal(2, new HugeScorpionAttackGoal(this, 1.15D, true));
...
//        this.goalSelector.addGoal(2, new TemptGoal(this, 1.2D, Ingredient.of(Items.ENDER_EYE), false));
    ...
    public static AttributeSupplier.Builder createAttributes() {
        return Animal.createLivingAttributes()
                ...
                .add(Attributes.ATTACK_DAMAGE, 0.8f)
